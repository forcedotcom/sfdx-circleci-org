...
This repository shows how to successfully setup deploying to non-scratch orgs (i.e. Sandbox or Production) with Circle CI. We make a few assumptions in this README:
